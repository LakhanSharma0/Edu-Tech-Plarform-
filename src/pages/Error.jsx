...
const Error = () => {
  return (
    <StyledWrapper className='w-full h-screen flex items-center justify-center text-white text-xl z-10'>
      <div className="main_wrapper">
        ...
        C86.34,11.918,137.664-5.445,189.928,1.502l-3.95,29.738C143.041,25.54,100.895,39.789,70.343,70.343z" />
          ...
          <div className="flex flex-row gap-2 items-center justify-center ">
            <div className="base1 mx-20" />
            <div className="base2 mx-20" />
            <div className="base3 text-sm" />
          </div>
        </div>
