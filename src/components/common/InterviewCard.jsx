...
import logo from "../../assets/AIinterview/logo.svg";
const InterviewCard = ({
  interviewId,
  userId,
  role,
    ...
    <div>
      <div class="parent">
          <div class="card">
              ...
              <div class="glass"></div>
              <div class="content">
                  <p className='text-white -my-3 font-bold'>Frontend Devloper Interview</p>
                  <span class="text">You haven't taken this interview yet. Take it now to improve your skills.</span>
              </div>
              <div class="bottom">
                  ...
                  <div class="view-more text-white btn">
                      <button class="text-center" onClick={InterviewHandle}>Take Interview</button>
                  </div>
